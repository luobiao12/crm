...
from permission_rbac.models import *
...
class UserInfo(models.Model):
    ...
    auth=models.OneToOneField(to=User,null=True)
...
class ConsultRecord(models.Model):
    ...
    class Meta:
        verbose_name = 'ConsultRecord客户跟进记录表'
        db_table = verbose_name
        verbose_name_plural = verbose_name
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo', limit_choices_to={"depart_id__in": [1002, 1003, 1007]})
